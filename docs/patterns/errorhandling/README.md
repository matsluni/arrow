...
// arrow.core.OptionMonadErrorInstanceImplicits$instance$1@198ff0f3
```

```kotlin
monadError<ForTry, Throwable>()
// arrow.data.TryMonadErrorInstanceImplicits$instance$1@d1171ec
```

```kotlin
monadError<EitherPartialOf<NukeException>, NukeException>()
// arrow.core.EitherMonadErrorInstanceImplicits$instance$1@dfb3f45
```
