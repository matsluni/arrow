...
eq<Int>()
// arrow.instances.IntEqInstance@d91fd24
```
...
// arrow.data.ListKApplicativeInstanceImplicits$instance$1@69bb796a
```
...
// arrow.core.OptionApplicativeInstanceImplicits$instance$1@68b31aa2
```
